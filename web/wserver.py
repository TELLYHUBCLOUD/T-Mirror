...
rawowners = "<h1 style='text-align: center'>See my Channel <a href='https://telegram.me/TELLYHUB'>@Telegram</a><br><br>By<br><br><a href='https://github.com/TELLYHUBCLOUD/T-Mirror'>T-Mirror</a></h1>"
...
<body>
    ...
    <header>
        ...
        <div class="social">
            <a href="https://github.com/TELLYHUBCLOUD/T-Mirror"><i class="fab fa-github"></i></a>
            <a href="https://telegram.me/TELLYHUB"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
